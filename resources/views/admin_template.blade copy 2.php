	...
	<div class="content">
		...
		<div class="navigation">
          ...
          @endforeach
				...
				<li>
					<a class="waves-effect parent-item js__control" href="#"><i class="menu-icon mdi mdi-close"></i><span>Closing / Pending</span><span class="menu-arrow fa fa-angle-down"></span></a>
					<ul class="sub-menu js__content">
  ...
  <script>
    ...
    $('#calang').keypress(function (e) {
      ...
      $('.done_go_live').click(function(){
            var atribut = $(this).attr('id');
            var id = atribut.replace('done_go_live_','')
